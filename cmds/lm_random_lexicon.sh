...
sed "s/ /\n/g" data_lexicon/"$lang"/random/train$n/corpus > data_lexicon/"$lang"/random/train$n/wordList
sort -u data_lexicon/"$lang"/random/train$n/wordList > data_lexicon/"$lang"/random/train$n/wordList.sorted


mkdir data_lexicon/"$lang"/random/train$n/local
mkdir data_lexicon/"$lang"/random/train$n/local/dict_base/
...
python3 scripts/create_lexicon.py -wordList data_lexicon/"$lang"/random/train$n/wordList.sorted > $local/dict_base/lexicon.txt
...
bash utils/prepare_lang.sh $local/dict_base/ "<UNK>" $local/lang_base data_lexicon/"$lang"/random/train$n/lang_base
...
ngram-count -order $lm_order -write-vocab $local/tmp_base/vocab-full.txt -wbdiscount -text data_lexicon/"$lang"/random/train$n/corpus -lm $local/tmp_base/lm.arpa

#original_lang=data_lexicon/"$lang"/lang

#mkdir data_lexicon/"$lang"/random/train$n/lang_base
#cp -R $original_lang/* data_lexicon/"$lang"/random/train$n/lang_base/

lang_dir=data_lexicon/"$lang"/random/train$n/lang_base
...
cat data_lexicon/"$lang"/random/train$n/corpus data_lexicon/"$lang"/local/corpus.txt > $local/corpus.txt

sed "s/ /\n/g" $local/corpus.txt > data_lexicon/"$lang"/random/train$n/wordList
sort -u data_lexicon/"$lang"/random/train$n/wordList > data_lexicon/"$lang"/random/train$n/wordList.sorted

mkdir data_lexicon/"$lang"/random/train$n/local/dict_large/

echo "SIL" > data_lexicon/"$lang"/random/train$n/local/dict_large/optional_silence.txt

echo "SIL" > data_lexicon/"$lang"/random/train$n/local/dict_large/silence_phones.txt
echo "SPN" >> data_lexicon/"$lang"/random/train$n/local/dict_large/silence_phones.txt

python3 scripts/create_lexicon.py -wordList data_lexicon/"$lang"/random/train$n/wordList.sorted > $local/dict_large/lexicon.txt
...
bash utils/prepare_lang.sh $local/dict_large/ "<UNK>" $local/lang_large data_lexicon/"$lang"/random/train$n/lang_large
...
#mkdir data_lexicon/"$lang"/random/train$n/lang_large
#cp -R $original_lang/* data_lexicon/"$lang"/random/train$n/lang_large/

lang_dir=data_lexicon/"$lang"/random/train$n/lang_large
